...
namespace Nibss.Net.EmailClient
{
    public static class Constants
    {
        ...
        public const string RESPONSE_STATUS_SUCCESSFUL = "00";
        public const string RESPONSE_STATUS_SUCCESSFUL_DESC = "Successful";
        public const string  RESPONSE_STATUS_FAILED = "01";
        public const string RESPONSE_STATUS_FAILED_DESC = "Failed";
        public const string RESPONSE_STATUS_PENDING = "02";
        public const string RESPONSE_STATUS_PENDING_DESC = "Pending";
        public const string  RESPONSE_STATUS_SENT = "00";
